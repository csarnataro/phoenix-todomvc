defmodule AppWeb.CoreComponents do
  ...
  attr :container_class, :string, default: "mt-10 space-y-8 bg-white"

  attr :rest, :global,
    include: ~w(autocomplete name rel action enctype method novalidate target class),
  ...
  attr :input_field_class, :string, default: ""
